...
# Perturbar as coordenadas dos vértices
perturbation_factor = 0.075  # Ajuste o fator conforme necessário
mesh_data.vectors += np.random.normal(0, perturbation_factor, mesh_data.vectors.shape)
